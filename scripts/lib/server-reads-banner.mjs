...
export const SERVER_READS_BANNER_HELPER =
  ...
  // nothing to show) has no roster to refresh from; a reload now paints the live one.
  + 'if(wasStale&&el&&!document.querySelector(".sand-agent-item[data-agent-id]")){el.textContent="Your server is back; refreshing.";setTimeout(function(){location.reload()},800);wasStale=!1;return}'
