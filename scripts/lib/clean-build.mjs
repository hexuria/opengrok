...
export const runtimeComposition = Object.freeze([
  ...
  { runtime: "electron-runtime-dependencies", path: "dist/deps", mode: "generated-runtime", reason: "Public native addons (better-sqlite3, tree-sitter, tree-sitter-bash) are rebuilt against Electron 42.1.0 (ABI 146) headers and staged as dist/deps; cursor-proclist is omitted and process scan no-ops." },
