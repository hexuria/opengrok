...
+".sand-us-frame{overflow:auto;border:1px solid var(--sand-border-default,rgba(128,128,128,.2));border-radius:8px;height:calc(var(--rows,5) * 32px + 31px);box-sizing:border-box}"
...
var readRows=function(){try{var v=localStorage.getItem(ROWS_KEY);return ROWS.indexOf(v)>=0?v:"5"}catch(_){return "5"}};
